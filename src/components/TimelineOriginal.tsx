...
export function TimelineOriginal() {
  return (
    <section
      id="trayectoria"
      className="original-section timeline-original"
      data-sec="07"
    >
      <SectionTitle
        eyebrow="EXPERIENCIA"
      ...
      <div className="timeline-list">
        {experiences.map((item) => (
          <article data-reveal key={item.company}>
            <div>
        ...
        <article data-reveal>
          ...
          <div className="education-flex">
            <div>
              ...
              <span>2024 — 2026 · UNIVERSIDAD TECNOLÓGICA DE LEÓN</span>
            </div>
            <div>
              <h3>TSU en Desarrollo de Software Multiplataforma</h3>
              <span>2022 — 2024 · UNIVERSIDAD TECNOLÓGICA DE LEÓN</span>
            </div>
          </div>
        </article>
      </div>
